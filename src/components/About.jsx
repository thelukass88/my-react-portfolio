...
const About = () => { 
  return (
    <div
      name="about"
      id="about"
      className="w-full h-25 bg-[#0a192f] text-gray-300"
    >
      <div className="flex flex-col mx-auto bg-green-100 justify-center items-center w-100% h-25">
        <div className="py-16 rounded-md bg-cyan-800 flex flex-col justify-center items-center w-4/6 mt-8 mb-8">
